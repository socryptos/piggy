...
function InactiveNav(props) {
    ...
    return(
        <>
            ...
            <div className="info">
                <div className="info__name"><a href="#priceInfo" ><img src={piggy_logo} width="40px" alt="piggy logo" /></a></div>
                ...
                <div className="info__bucket"><a href="#piggy"><img src="https://img.icons8.com/?size=40&id=wv5Hl1ChDaN5&format=png&color=ff13f0" width="40px" alt="bucket" /></a></div>
                <div className="info__oinknomicks"><a href="#oinkenomicks"><img src="https://img.icons8.com/?size=40&id=6552&format=png&color=ff13f0" width="30px" alt="token" /></a></div>
            </div>
